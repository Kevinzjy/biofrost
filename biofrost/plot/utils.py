"""Functions for plotting with matplotlib/seaborn"""
...
def customize_cmap(colors, intervals, N=256):
    """Generate continuous cmap from given color intervals and length

    Args:
        colors (list): List of Matplotlib color specifications, or an equivalent Nx3 or Nx4 floating point array (N rgb or rgba values).
        intervals (list): List of lengths between each pair of adjacent colors.
        N (int, optional): Number of entries in the map.. Defaults to 256.

    Returns:
        matplotlib.colors.ListedColormap: customized cmap
    """
...
def get_value_colors(row_val, palette=None, size=50):
    """Get exact colors for given values using specific palette"""
